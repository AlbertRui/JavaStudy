...
public class Proxy {
	...
	public static Object newProxyInstance(Class infce,InvocationHandler h) throws Exception{
		...
		String str =
		"package me.pattern.proxy.imitate_jdk_proxys;" + rt +
		"import java.lang.reflect.Method;" + rt +
		"import me.pattern.proxy.imitate_jdk_proxy.InvocationHandler;" +  rt+
		...
		Class c = cl.loadClass("me.pattern.proxy.$Proxy0");
